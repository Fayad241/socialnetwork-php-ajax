  ...
  <div class="bg-white rounded-2xl shadow-sm p-7 w-full max-w-lg mb-12">
    ...
    <form id="multiStepForm">
      ...
      <div class="step flex gap-3 flex-col" data-step="1">
          ...
          <textarea class="w-full resize-none px-4 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-1 focus:ring-blue-400 h-28 transition"
      ...
      <div class="step hidden" data-step="2">
          <div class="mb-4">
            ...
            <div id="genderGroup" class="flex gap-3">
              <button type="button" class="w-[33%] gender-option px-4 py-2 rounded-md border border-gray-300 bg-white text-gray-600 hover:bg-blue-50 focus:bg-blue-500 focus:text-white outline-0 focus:font-semibold transition cursor-pointer" data-value="homme">
              👨 Homme
              </button>
              <button type="button" class="w-[33%] gender-option px-4 py-2 rounded-md border border-gray-300 bg-white text-gray-600 hover:bg-pink-50 focus:bg-pink-500 focus:text-white focus:font-semibold outline-0 transition cursor-pointer" data-value="femme">
              👩 Femme
              </button>
              <button type="button" class="w-[33%] gender-option px-4 py-2 rounded-md border border-gray-300 bg-white text-gray-600 outline-0 hover:bg-purple-50 focus:bg-purple-500 focus:text-white focus:font-semibold transition cursor-pointer" data-value="autre">
              🌈 Autre
              </button>
            </div>
          ...
          <div class="mb-4">
              ...
              <input type="date" name="dob" class="px-4 py-2 w-full border border-gray-300 rounded-md bg-white text-gray-700 focus:outline-none focus:ring-2 focus:ring-blue-400 transition" />
          </div>
      </div>
      ...
      <div class="step hidden" data-step="3">
        ...
        <div class="relative border-2 border-dashed border-gray-300 rounded-lg p-6 flex flex-col items-center justify-center text-center cursor-pointer hover:border-blue-500 transition" 
          ...
          <input type="file" name="photo" id="profileUpload" accept="image/*" class="hidden" >
